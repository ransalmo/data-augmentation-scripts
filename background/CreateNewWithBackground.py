...
def create_new_image_with_backcground(source_folder, destiny_folder, backgrounds_path):
    ...
    for image in images:
        ...
        height_back, width_back = temp_back.shape
        height_image, width_image = temp_image.shape
        ...
        cv2.imwrite(temp_back, back_ground_temp_path)
        leaf_temp_path = os.path.join(os.getcwd(), "wkr_image.png")
        grabcut_temp(temp_image, [0,0,width_image,height_image], leaf_temp_path)
